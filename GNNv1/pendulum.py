...
dicts_in_static, dicts_in_dynamic, dicts_out_static, dicts_out_dynamic = sample_trajectories(env, TRAJECTORIES_NUMBER, m, l, g, build_dics_pendulum)
...
dicts_in_static_test, dicts_in_dynamic_test, dicts_out_static_test, dicts_out_dynamic_test = sample_trajectories(env, TRAJECTORIES_NUMBER, m, l, g, build_dics_pendulum)
